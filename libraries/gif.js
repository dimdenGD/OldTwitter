...
const stringWorker = fn => new Worker(window.URL.createObjectURL(new Blob([fn], {type: "text/javascript"})));
fetch(chrome.runtime.getURL("libraries/gif.worker.js")).then(response => response.text()).then(workerCode => {
(function(f) {
    ...
    return function e(t, n, r) {
        ...
        3: [function(require, module, exports) {
            ...
            GIF = function(superClass) {
                ...
                defaults = {
                    workerScript: chrome.runtime.getURL("libraries/gif.worker.js"),
                    workers: 2,
                    repeat: 0,
                    background: "#fff",
                    quality: 10,
                ...
                GIF.prototype.spawnWorkers = function() {
                    ...
                    (function() {
                        ...
                        return function(i) {
                            ...
                            worker = stringWorker(workerCode);
