...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.twttr = global.twttr || {}, global.twttr.txt = factory()));
    ...
    var require$$1$5 = ( _core$1 && _core ) || _core$1;
    ...
    var shared$1 = ( _shared$1 && _shared ) || _shared$1;
    ...
    if (PATCH) {
      patchedExec = function exec(str) {
        ...
        if (NPCG_INCLUDED) {
          reCopy = new RegExp('^' + re.source + '$(?!\\s)', $flags.call(re));
        }
    ...
    var require$$1$4 = ( _domCreate$1 && _domCreate ) || _domCreate$1;
  
    var _ie8DomDefine = !DESCRIPTORS && !$fails(function () {
      return Object.defineProperty(require$$1$4('div'), 'a', { get: function () { return 7; } }).a != 7;
    });
    ...
    var f$6 = DESCRIPTORS ? Object.defineProperty : function defineProperty(O, P, Attributes) {
      anObject(O);
    ...
    var _functionToString = shared$1('native-function-to-string', Function.toString);
    ...
    var $toString$2 = ( _functionToString$1 && _functionToString ) || _functionToString$1;
  
    var _redefine = createCommonjsModule(function (module) {
    var SRC = uid('src');
  
    var TO_STRING = 'toString';
    var TPL = ('' + $toString$2).split(TO_STRING);
  
    require$$1$5.inspectSource = function (it) {
      return $toString$2.call(it);
    };
  
    (module.exports = function (O, key, val, safe) {
      var isFunction = typeof val == 'function';
      if (isFunction) has(val, 'name') || require$$4(val, 'name', key);
      if (O[key] === val) return;
      if (isFunction) has(val, SRC) || require$$4(val, SRC, O[key] ? '' + O[key] : TPL.join(String(key)));
      if (O === global$1) {
        O[key] = val;
      } else if (!safe) {
        delete O[key];
    ...
    var $export$1 = function (type, name, source) {
      ...
      var target = IS_GLOBAL ? global$1 : IS_STATIC ? global$1[name] || (global$1[name] = {}) : (global$1[name] || {})[PROTOTYPE$2];
      var exports = IS_GLOBAL ? require$$1$5 : require$$1$5[name] || (require$$1$5[name] = {});
      ...
      for (key in source) {
        ...
        // export
        if (exports[key] != out) require$$4(exports, key, exp);
        if (IS_PROTO && expProto[key] != out) expProto[key] = out;
      }
    };
    global$1.core = require$$1$5;
    // type bitmap
    $export$1.F = 1;   // forced
    $export$1.G = 2;   // global
    $export$1.S = 4;   // static
    ...
    var SPECIES$3 = require$$0$8('species');
    ...
    var _fixReWks = function (KEY, length, exec) {
      ...
      if (
        ...
        require$$4(RegExp.prototype, SYMBOL, length == 2
    ...
    var require$$1$3 = ( _strictMethod$1 && _strictMethod ) || _strictMethod$1;
  
    var $indexOf = require$$0$6(false);
    var $native = [].indexOf;
    var NEGATIVE_ZERO = !!$native && 1 / [1].indexOf(1, -0) < 0;
  
    $export($export.P + $export.F * (NEGATIVE_ZERO || !require$$1$3($native)), 'Array', {
    ...
    var f$4 = DESCRIPTORS ? gOPD$1 : function getOwnPropertyDescriptor(O, P) {
      O = toIObject(O);
      P = toPrimitive(P, true);
      if (IE8_DOM_DEFINE) try {
        return gOPD$1(O, P);
      } catch (e) { /* empty */ }
      if (has(O, P)) return createDesc(!require$$2$1.f.call(O, P), O[P]);
    };
    ...
    var setPrototypeOf = require$$0$5.set;
    ...
    var $keys$1 = ( _objectKeysInternal$1 && _objectKeysInternal ) || _objectKeysInternal$1;
    ...
    var SPECIES$2 = require$$0$8('species');
  
    var _setSpecies = function (KEY) {
      var C = global$1[KEY];
      if (DESCRIPTORS && C && !C[SPECIES$2]) $DP.f(C, SPECIES$2, {
        configurable: true,
    ...
    if (DESCRIPTORS && (!CORRECT_NEW || $fails(function () {
      re2[require$$0$8('match')] = false;
    ...
    var extractUrlsWithIndices = function extractUrlsWithIndices(text) {
      ...
      var _loop = function _loop() {
        ...
        if (!isValidUrl$1(url, protocol || DEFAULT_PROTOCOL, domain)) {
          return "continue";
    ...
    var isValidUrl$1 = function isValidUrl(url, protocol, domain) {
    ...
    // 21.2.5.3 get RegExp.prototype.flags()
    if (DESCRIPTORS && /./g.flags != 'g') $DP.f(RegExp.prototype, 'flags', {
      configurable: true,
      get: $flags
    });
    ...
    if ($fails(function () { return $toString$1.call({ source: 'a', flags: 'b' }) != '/a/b'; })) {
    ...
    var test = {};
    test[require$$0$8('toStringTag')] = 'z';
    if (test + '' != '[object z]') {
     ...
     */
    var convertUnicodeIndices$1 = function convertUnicodeIndices(text, entities, indicesInUTF16) {
      if (entities.length === 0) {
        return;
      }
    ...
    function modifyIndicesFromUnicodeToUTF16 (text, entities) {
      convertUnicodeIndices$1(text, entities, false);
    }
    ...
    $export($export.S, 'Array', { isArray: isArray });
    ...
    function modifyIndicesFromUTF16ToUnicode (text, entities) {
      convertUnicodeIndices$1(text, entities, true);
    }
    ...
    $export($export.P + $export.F * !require$$1$3([].reduce, true), 'Array', {
    ...
    var UNSCOPABLES = require$$0$8('unscopables');
    ...
    var $keys = ( _objectKeys$1 && _objectKeys ) || _objectKeys$1;
    ...
    require$$4(IteratorPrototype, require$$0$8('iterator'), function () { return this; });
    ...
    var ITERATOR$4 = require$$0$8('iterator');
    ...
    var _iterDefine = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
      ...
      if ($anyNative) {
        ...
        if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
          ...
          if (!require$$3 && typeof IteratorPrototype[ITERATOR$4] != 'function') require$$4(IteratorPrototype, ITERATOR$4, returnThis);
        }
      }
      ...
      // Define iterator
      if ((!require$$3 || FORCED) && (BUGGY || VALUES_BUG || !proto[ITERATOR$4])) {
        require$$4(proto, ITERATOR$4, $default);
      }
      // Plug for library
    ...
    var require$$1 = ( _iterDefine$1 && _iterDefine ) || _iterDefine$1;
  
    // 22.1.3.4 Array.prototype.entries()
    // 22.1.3.13 Array.prototype.keys()
    // 22.1.3.29 Array.prototype.values()
    // 22.1.3.30 Array.prototype[@@iterator]()
    var es6_array_iterator = require$$1(Array, 'Array', function (iterated, kind) {
    ...
    for (var collections = $keys(DOMIterables), i = 0; i < collections.length; i++) {
      ...
      var key;
      if (proto) {
        if (!proto[ITERATOR$3]) require$$4(proto, ITERATOR$3, ArrayValues);
        if (!proto[TO_STRING_TAG]) require$$4(proto, TO_STRING_TAG, NAME);
    ...
    var _objectSap = function (KEY, exec) {
      var fn = (require$$1$5.Object || {})[KEY] || Object[KEY];
      var exp = {};
      exp[KEY] = exec(fn);
    ...
    $export($export.S + $export.F * !DESCRIPTORS, 'Object', { defineProperty: $DP.f });
  
    // 19.1.2.3 / 15.2.3.7 Object.defineProperties(O, Properties)
    $export($export.S + $export.F * !DESCRIPTORS, 'Object', { defineProperties: require$$1$1 });
    ...
    var ownKeys$1 = ( _ownKeys$1 && _ownKeys ) || _ownKeys$1;
    ...
    var require$$0$2 = ( _arrayMethods$1 && _arrayMethods ) || _arrayMethods$1;
  
    var $forEach = require$$0$2(0);
    var STRICT = require$$1$3([].forEach, true);
    ...
    var $filter = require$$0$2(2);
  
    $export($export.P + $export.F * !require$$1$3([].filter, true), 'Array', {
    ...
    var defineProperty$1 = $DP.f;
    var _wksDefine = function (name) {
      var $Symbol = require$$1$5.Symbol || (require$$1$5.Symbol = require$$3 ? {} : global$1.Symbol || {});
    ...
    var f = function getOwnPropertyNames(it) {
      return windowNames && toString.call(it) == '[object Window]' ? getWindowNames(it) : gOPN$1(toIObject(it));
    };
    ...
    var require$$0$1 = ( _meta$1 && _meta ) || _meta$1;
    ...
    for (var wellKnownSymbols = $keys(require$$0$8.store), k = 0; wellKnownSymbols.length > k;) wksDefine(wellKnownSymbols[k++]);
    ...
    require$$1(String, 'String', function (iterated) {
    ...
    var core_getIteratorMethod = require$$1$5.getIteratorMethod = function (it) {
    ...
    var require$$0 = ( _iterDetect$1 && _iterDetect ) || _iterDetect$1;
  
    $export($export.S + $export.F * !require$$0(function (iter) { Array.from(iter); }), 'Array', {
