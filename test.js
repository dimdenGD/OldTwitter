...
const languageCodes = [
    ...
    {"code":"zh_CN","name":"Chinese (Simplified)","nativeName":"中文 (Zhōngwén), 汉语, 漢語"},
    {"code":"zh_TW","name":"Chinese (Traditional)","nativeName":"中文 (Zhōngwén), 汉语, 漢語"},
    ...
    {"code":"pt_BR","name":"Portuguese (Brazil)","nativeName":"Português do Brasil"},
