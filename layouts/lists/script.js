...
function renderListData(data) {
    ...
    if(data.user_results && data.user_results.result) {
        ...
        document.getElementById('list-avatar').src = `${(data.user_results.result.legacy.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_normal.png`): data.user_results.result.legacy.profile_image_url_https}`.replace('_normal', '_bigger');
                    ...
                    for(let i in listMembers) {
                        ...
                        <div style="height:48px">
                            <a href="https://twitter.com/${t.screen_name}" class="following-item-link">
                                <img src="${(t.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_normal.png`): t.profile_image_url_https}" alt="${t.screen_name}" class="following-item-avatar tweet-avatar" width="48" height="48">
    ...
    for(let i in listFollowers) {
        ...
        <div style="height:48px">
            <a href="https://twitter.com/${t.screen_name}" class="user-item-link">
                <img src="${(t.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_normal.png`): t.profile_image_url_https}" alt="${t.screen_name}" class="user-item-avatar tweet-avatar" width="48" height="48">
