...
async function renderProfile() {
    ...
    document.getElementById('profile-avatar').addEventListener('error', () => {
        ...
        attempts++;
        setTimeout(() => {
            document.getElementById('profile-avatar').src = `${(pageUser.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_images/default_profile_normal.png`): pageUser.profile_image_url_https}`.replace('_normal.', '_400x400.');
        }, 500);
    });
    ...
    document.getElementById('profile-avatar').src = `${(pageUser.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_images/default_profile_normal.png`): pageUser.profile_image_url_https}`.replace('_normal.', '_400x400.');
    document.getElementById('nav-profile-avatar').src = `${(pageUser.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_images/default_profile_normal.png`): pageUser.profile_image_url_https}`.replace('_normal.', '_bigger.');
    ...
    document.getElementById('profile-avatar-link').href = `${(pageUser.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_images/default_profile_normal.png`): pageUser.profile_image_url_https}`.replace('_normal.', '_400x400.');
    ...
    if(followersYouFollow && followersYouFollow.total_count > 0) {
        ...
        followersYouFollow.users.forEach(u => {
            ...
            avatar.src = `${(u.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_images/default_profile_normal.png`): u.profile_image_url_https}`.replace('_normal', '_bigger');
            avatar.width = 45;
            avatar.height = 45;
