...
function renderUserData() {
    ...
    document.getElementById('new-tweet-avatar').src = `${(user.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_normal.png`): user.profile_image_url_https}`.replace("_normal", "_bigger");
            ...
            members.forEach(u => {
                ...
                userElement.innerHTML = /*html*/`
                    <a href="/${u.legacy.screen_name}" target="_blank" style="text-decoration:none!important">
                        <img class="new-message-user-avatar" src="${`${(u.legacy.default_profile_image && vars.useOldDefaultProfileImage) ? chrome.runtime.getURL(`images/default_profile_normal.png`): u.legacy.profile_image_url_https}`.replace("_normal", "_bigger")}" width="48" height="48">
