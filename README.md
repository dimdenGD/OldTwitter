...
**Installing this way on Firefox will remove it after closing browser. You need to use Firefox for Developers instead for permament installation (see below).**
