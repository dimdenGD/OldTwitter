...
copyDir('./', '../OldTwitterFirefox').then(async () => {
    ...
    manifest.content_scripts = [
        ...
        },
        {
          ...
          "js": ["scripts/config.js", "scripts/helpers.js", "scripts/apis.js", "scripts/injection.js", "libraries/twemoji.min.js", "libraries/custom-elements.min.js", "libraries/emojipicker.js", "libraries/twitter-text.js"],
          "all_frames": true,
          "run_at": "document_start"
        },
        {
