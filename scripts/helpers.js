        ...
        tweet.innerHTML = /*html*/`
            ...
            <div class="tweet-body ${options.mainTweet ? 'tweet-body-main' : ''}">
                ...
                <div class="tweet-interact">
                    ...
                    ${(vars.bookmarkButton === 'show_all' || vars.bookmarkButton === 'show_all_no_count' || vars.bookmarkButton === 'show_dynamic' || (vars.bookmarkButton === 'show_main' && options.mainTweet)) && (t.bookmark_count || vars.bookmarkButton !== 'show_dynamic') ? 
                        /*html*/`<span title="${LOC.bookmarks_count.message}" class="tweet-interact-bookmark${t.bookmarked ? ' tweet-interact-bookmarked' : ''}" data-val="${t.bookmark_count}">${vars.bookmarkButton !== 'show_all_no_count' ? Number(t.bookmark_count).toLocaleString().replace(/\s/g, ',') : ''}</span>` :
                    ''}
