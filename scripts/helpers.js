        ...
        <div>
            <a href="https://twitter.com/${u.screen_name}" class="user-item-link">
                ...
                <div class="user-item-text">
                    <span class="tweet-header-name user-item-name${u.protected ? ' user-protected' : ''}${u.verified || u.id_str === '1123203847776763904' ? ' user-verified' : ''}">${escapeHTML(u.name)}</span><br>
