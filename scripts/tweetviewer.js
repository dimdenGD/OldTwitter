  ...
  async updateReplies(id, c) {
    ...
    try {
      ...
      if (!tlData.value) {
        if (!c) {
          tvl.hidden = true;
          document.getElementsByClassName("timeline")[0].innerHTML = html`<span
    ...
    for (let i in tweetRetweeters) {
      ...
      retweetElement.innerHTML = html` <div>
          <a href="/${u.screen_name}" class="following-item-link">
            <img
              src="${u.default_profile_image && vars.useOldDefaultProfileImage
        ...
        <div>
          <button
            class="following-item-btn nice-button ${u.following
              ...
              : "follow"}"
          >
            ${u.following ? LOC.following_btn.message : LOC.follow.message}
          </button>
        </div>`;
  ...
  async appendComposeComponent(container, replyTweet) {
          ...
          let modal = createModal(html`
            ...
            >
              ...
              <div class="new-tweet-mentions-modal-item">
                <input
                  type="checkbox"
                  id="new-tweet-mentions-modal-item-${replyTweet.user
                    .screen_name}"
                  checked
                  disabled
                />
                <label
                  for="new-tweet-mentions-modal-item-${replyTweet.user
                    .screen_name}"
                  ...
                  return html`
                    <div class="new-tweet-mentions-modal-item">
                      <input
                        ...
                        ${this.excludeUserMentions.includes(u.id_str)
                          ? ""
                          : " checked"}${this.user.screen_name === m
                          ? " hidden"
                          : ""}
                      />
                      <label
                        for="new-tweet-mentions-modal-item-${m}"
                        ${this.user.screen_name === m ? " hidden" : ""}
                        >${u.name} (@${m})</label
                      >
                    </div>
                  `;
    ...
    newTweetText.addEventListener("keydown", async (e) => {
      if (e.key === "ArrowDown") {
        if (selectedIndex < newTweetUserSearch.children.length - 1) {
          ...
          newTweetUserSearch.children[selectedIndex - 1].classList.remove(
            "search-result-item-active"
          );
        } else {
          selectedIndex = 0;
        ...
        users.forEach((user, index) => {
          ...
          userElement.addEventListener("click", () => {
            ...
            if (newTweetText.value.length > 280)
              newTweetText.value = newTweetText.value.slice(0, 280);
            newTweetText.focus();
            newTweetUserSearch.innerHTML = "";
            newTweetUserSearch.hidden = true;
          });
    ...
    newTweetButton.addEventListener("click", async () => {
      ...
      if (this.excludeUserMentions.length > 0)
        tweetObject.exclude_reply_user_ids = this.excludeUserMentions.join(",");
      ...
      try {
        ...
        this.appendTweet(
          ...
          {
            after:
              document.getElementsByClassName("new-tweet-view")[0]
                .parentElement,
          }
        );
      } catch (e) {
  ...
  async appendTweet(t, timelineContainer, options = {}) {
    ...
    if (!options.mainTweet) {
      tweet.addEventListener("click", async (e) => {
        ...
        if (
          ...
          selection.focusNode &&
          selection.focusNode.closest(`div.tweet[data-tweet-id="${t.id_str}"]`)
        ) {
          return;
        }
        if (
    ...
    if (videos) {
      for (let v of videos) {
        ...
        if (localStorage.preferredQuality && vars.savePreferredQuality) {
          ...
          let preferredQualityVariantIndex = v.video_info.variants.findIndex(
          ...
          let lowestQualityVariantIndex = v.video_info.variants.findIndex(
        ...
        >
          <b
            ${t.user.id_str === "1708130407663759360"
              ...
              : ""} ${t.user.protected ? "user-protected" : ""} ${t.user
      ...
      <article class="tweet-body ${options.mainTweet ? "tweet-body-main" : ""}">
        ...
        >
          <span class="tweet-body-text-span"
            >${vars.useOldStyleReply
              ...
              : ""}${full_text ? await renderTweetBodyHTML(t) : ""}</span
          >
        </div>
        ${!isMatchingLanguage
          ? html`
                    ...
                    <div class="tweet-media-controls">
                      ...
                      videos[0].ext.mediaStats.r.ok
                        ? `<span class="tweet-video-views">${Number(
                            videos[0].ext.mediaStats.r.ok.viewCount
                          )
                            .toLocaleString()
                            .replace(/\s/g, ",")} ${
                            LOC.views.message
          ...
          ? html`
              ...
              >
                <img
                  ...
                  alt="${escapeHTML(t.quoted_status.user.name, true)}"
                ...
                <div class="tweet-header-quote">
                  <span class="tweet-header-info-quote">
                    <b
                      class="tweet-header-name-quote ${t.quoted_status.user
                        .verified ||
                ...
                <span
                  ...
                  >${vars.useOldStyleReply ? quoteMentionedUserText : ""}${t
                ...
                ${!isQuoteMatchingLanguage
                  ? html`
                      <span class="tweet-button tweet-quote-translate"
                        >${LOC.view_translation.message}</span
                      >
                    `
                  : ``}
              ...
              <div class="tweet-footer">
                <div class="tweet-footer-stats">
                  ...
                  >
                    ...
                    >
                    <b class="tweet-footer-stat-count tweet-footer-stat-replies"
                  ...
                  t.quote_count > 0 /*html*/
                    ? `<a href="/${t.user.screen_name}/status/${
                        t.id_str
        ...
        <div class="tweet-interact">
          <span
            ...
            >${options.mainTweet
              ? ""
              : formatLargeNumber(t.reply_count).replace(/\s/g, ",")}</span
          >
          <span
            ...
            >${options.mainTweet
              ? ""
              : formatLargeNumber(t.retweet_count).replace(/\s/g, ",")}</span
          >
          <div class="tweet-interact-retweet-menu dropdown-menu" hidden>
            ...
            ${options.mainTweet
              ? html`
                  ...
                  >
                  <span class="tweet-interact-retweet-menu-retweeters"
          ...
          <span
            title="${vars.heartsNotStars
              ...
              : LOC.favorite_btn.message}${!vars.disableHotkeys ? " (L)" : ""}"
            ...
            >${options.mainTweet
              ? ""
              : formatLargeNumber(t.favorite_count).replace(/\s/g, ",")}</span
          >
          ...
          t.ext.views.r.ok.count
            ? html`<span
                ...
                >${formatLargeNumber(t.ext.views.r.ok.count).replace(
                  /\s/g,
                  ","
                )}</span
              >`
          ...
          <div class="tweet-interact-more-menu dropdown-menu" hidden>
            ...
            ${t.user.id_str === user.id_str
              ? html`
                  <hr />
                  <span class="tweet-interact-more-menu-analytics"
            ...
            ${t.user.id_str !== user.id_str
              ? html`
                  <span class="tweet-interact-more-menu-block"
                    >${t.user.blocking ? unblockUserText : blockUserText}</span
                  >
                  ...
                  >
                  <span class="tweet-interact-more-menu-lists-action"
            ...
            t.extended_entities.media[0].type === "animated_gif"
              ? html`<span
                ...
                >`
              : ``}
            ${t.extended_entities && t.extended_entities.media.length > 1
              ? t.extended_entities.media
                  ...
                  .map(
                    (m, i) =>
                      html`<span
                        class="tweet-interact-more-menu-download-gif"
                        data-gifno="${i + 1}"
                        >${LOC.download_gif.message} (#${i + 1})</span
                      >`
                  )
                  .join("\n")
              : ""}
            ...
            ${vars.developerMode
              ? html`
                  <hr />
                  <span class="tweet-interact-more-menu-copy-user-id"
                    >${LOC.copy_user_id.message}</span
                  >
                  <span class="tweet-interact-more-menu-copy-tweet-id"
        ...
        <div class="tweet-edit-section tweet-reply" hidden>
          ...
          <b style="font-size: 12px;display: block;margin-bottom: 5px;"
            ...
            >
            <span class="tweet-reply-add-emoji">${LOC.emoji_btn.message}</span>
            <span
          ...
          <span class="tweet-reply-char"
            >${localStorage.OTisBlueVerified ? "0/25000" : "0/280"}</span
          ><br />
        ...
        <div class="tweet-edit-section tweet-quote" hidden>
          ...
          <b style="font-size: 12px;display: block;margin-bottom: 5px;"
            ...
            <span
              ...
              >${LOC.upload_media_btn.message}</span
            >
            <span class="tweet-quote-add-emoji">${LOC.emoji_btn.message}</span>
            <span
                  ...
                  .map(
                    (m) =>
                      `<${m.type === "photo" ? "img" : "video"} ${
                        ...
                        sizeFunctions[t.extended_entities.media.length](
                          m.original_info.width,
                          m.original_info.height
                        )[0]
                      }" height="${
                        ...
                        m.type === "animated_gif" && !vars.disableGifAutoplay
                          ? " autoplay"
                          : ""
                      } ${
                        m.type === "photo" ? `src="${m.media_url_https}"` : ""
                      } class="tweet-media-element ${
                        mediaClasses[t.extended_entities.media.length]
                      } ${
                        !vars.displaySensitiveContent && t.possibly_sensitive
                          ? "tweet-media-element-censor"
                          : ""
                      }">${
    ...
    if (options.mainTweet) {
      ...
      for (let i in likers) {
        ...
        likerImg.src = `${
          liker.default_profile_image && vars.useOldDefaultProfileImage
            ? chrome.runtime.getURL(
                `images/default_profile_images/default_profile_${
      ...
      repliesLink.addEventListener("click", (e) => {
        e.preventDefault();
        if (location.href === `/${t.user.screen_name}/status/${t.id_str}`)
          return;
        history.pushState(
          {},
          null,
    ...
    const tweetInteractMoreMenuDownloadGifs = Array.from(
      tweet.getElementsByClassName("tweet-interact-more-menu-download-gif")
    );
    ...
    if (tweetInteractMoreMenuListsAction)
      tweetInteractMoreMenuListsAction.addEventListener("click", async () => {
        createModal(`
          ...
          listElement.innerHTML = html`
              ...
              <a href="/i/lists/${l.id_str}" class="following-item-link">
                <img
                  ...
                  src="${l.custom_banner_media
                    ? l.custom_banner_media.media_info.original_img_url
                    : l.default_banner_media.media_info.original_img_url}"
                  alt="${l.name}"
                  class="following-item-avatar tweet-avatar"
                  width="48"
                  height="48"
                ...
                >
                  ...
                  <span
                    ...
                    >${l.description
                      ? escapeHTML(l.description).slice(0, 52)
                      : LOC.no_description.message}</span
                  >
                </div>
              </a>
            </div>
            <div style="display:inline-block;float: right;margin-top: 5px;">
              <button class="nice-button">
                ${l.is_member ? LOC.remove.message : LOC.add.message}
              </button>
            </div>
          `;
          ...
          listElement
            ...
            .addEventListener("click", async () => {
              if (l.is_member) {
                ...
                l.is_member = false;
                listElement.getElementsByClassName("nice-button")[0].innerText =
                  LOC.add.message;
              } else {
    ...
    if (tweetBodyQuote) {
      ...
      if (tweetQuoteTranslate) {
        ...
        tweetQuoteTranslate.addEventListener("click", async (e) => {
          ...
          if (translated.text.trim() === tt.replace(/(hihi)|(hehe)/g, "lol"))
            return; // lol
        ...
        if (
          options.translate ||
          vars.autotranslateProfiles.includes(t.quoted_status.user.id_str) ||
          (typeof toAutotranslate !== "undefined" && toAutotranslate) ||
          (vars.autotranslateLanguages.includes(t.quoted_status.lang) &&
      ...
      if (!t.retweeted) {
        ...
        try {
          tweetData = await API.tweet.unretweet(
            t.retweeted_status ? t.retweeted_status.id_str : t.id_str
          );
        } catch (e) {
          console.error(e);
          return;
    ...
    tweetInteractFavorite.addEventListener("click", () => {
      if (t.favorited) {
        ...
        if (!options.mainTweet) {
          ...
          if (
            this.mainTweetLikers.find((liker) => liker.id_str === user.id_str)
          ) {
    ...
    if (tweetInteractMoreMenuMuteUser)
      tweetInteractMoreMenuMuteUser.addEventListener("click", async () => {
        if (t.user.muting) {
          await API.user.unmute(t.user.id_str);
          t.user.muting = false;
          tweetInteractMoreMenuMuteUser.innerText =
            LOC.mute_user.message.replace("$SCREEN_NAME$", t.user.screen_name);
          ...
          toast.info(
            LOC.muted_user.message.replace("$SCREEN_NAME$", t.user.screen_name)
          );
        }
        chrome.storage.local.set(
          { tweetReplies: {}, tweetDetails: {} },
      ...
      tweetInteractMoreMenuDelete.addEventListener("click", async () => {
        ...
        Array.from(
          document
            ...
            .querySelectorAll(`div.tweet[data-tweet-id="${t.id_str}"]`)
        ).forEach((tweet) => {
          tweet.remove();
        });
        ...
        if (options.after) {
          if (options.after.getElementsByClassName("tweet-self-thread-div")[0])
          ...
          if (!options.after.classList.contains("tweet-main"))
            options.after.getElementsByClassName(
              ...
              +options.after.getElementsByClassName("tweet-interact-reply")[0]
                .innerText - 1
            ).toString();
          else
            options.after.getElementsByClassName(
    ...
    tweetInteractMoreMenuRefresh.addEventListener("click", async () => {
      ...
      if (
        tweetInteractFavorite.className.includes("tweet-interact-favorited") &&
        !tweetData.favorited
      ) {
        tweetInteractFavorite.classList.remove("tweet-interact-favorited");
      }
      if (
        tweetInteractRetweet.className.includes("tweet-interact-retweeted") &&
        !tweetData.retweeted
      ) {
        tweetInteractRetweet.classList.remove("tweet-interact-retweeted");
      }
      ...
      tweetInteractMoreMenuDownloadGifs.forEach((dgb) =>
        dgb.addEventListener("click", (e) => {
          ...
          let interval = setInterval(async () => {
            ...
            mde.innerText = `${LOC.initialization.message}... (${Math.round(
